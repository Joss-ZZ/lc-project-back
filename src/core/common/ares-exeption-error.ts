...
import { ErrorMenssage, TypeError } from './ares-error.enum';
...
export class AresExeption {
	...
	// static custom(enumError: ErrroMenssage, statusCode: HttpStatus): void {
	// 	const { message, typeError } = enumError;
